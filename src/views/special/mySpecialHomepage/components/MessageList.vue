<template>
  <el-card class="banner-card">
    <el-breadcrumb slot="header" separator-class="el-icon-arrow-right">
      <el-breadcrumb-item class="headPage" @click.native="backMyHome()">我的专题</el-breadcrumb-item>
    ...
    <el-row>
      <el-col :span="24" class="top-box">
        <span class="top-title">
          {{title}}
          <!-- <el-badge :value="messageLists.length" :max="99" class="item">
                  {{title}}
          </el-badge>-->
        </span>
      </el-col>
    ...
    <el-row v-else>
      <el-col :span="24" class="noNotice">暂无消息通知</el-col>
    </el-row>
  </el-card>
</template>
      <script>
