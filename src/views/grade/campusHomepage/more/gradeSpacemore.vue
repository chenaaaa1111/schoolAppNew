      ...
      <el-col :xl="18" :lg="18" :md="20" :sm="22" :xs="24" class="more-box">
        <el-card>
          ...
          <div class="card-content">
            <el-row class="more-list" v-for="(item, index) in gradeSpaceList" :key="index">
              <el-col :span="24" class="news-title">{{item.title}}</el-col>
              <el-col :span="24" class="news-list">
                <el-button type="text" v-for="(res, num) in item.class" :key="num">{{res.title}}</el-button>
              </el-col>
              <el-col :span="24">
